...
const QuizHome = ({ quiz }) => {
    ...
    return (
        <div className='bg-gray-100 p-6 rounded shadow-lg'>
            ...
            <Link to={`/quiz/${id}`} class="inline-flex items-center py-3 px-8 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                Start Practice
